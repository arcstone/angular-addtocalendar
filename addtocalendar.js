        ...
        '$scope', function ($scope) {
            ...
            $scope.getIcsCalendarUrl = function () {
                cal.addEvent(
                    ...
                    $scope.description,
                    $scope.location,
                    ($scope.utc == true) ? utcToDate($scope.startDate) : toDate($scope.startDate),
                    ($scope.utc == true) ? utcToDate($scope.endDate) : toDate($scope.endDate)
                );
            ...
            var getMicrosoftCalendarUrl = function () {
                ...
                microsoftCalendarUrl += '&dtstart=' + encodeURI($scope.startDate) + '&dtend=' +
                                        encodeURI($scope.endDate);
    ...
    .directive('addtocalendarstrap', function () {
        return {
            ...
            <button type="button" \
                    ...
                    bs-dropdown="calendarTypes" \
                    aria-haspopup="true" \
                    aria-expanded="false">Add to calendar</button>\
            '
        };
    });
